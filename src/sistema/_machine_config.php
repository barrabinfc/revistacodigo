...
GlobalConfig::$CONNECTION_SETTING->DBName = "sistema";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "vaiaviva";
...
/** the root url of the application with trailing slash, for example http://localhost/sistema/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'sistema/';
