...
class paisController extends AppBaseController
{
	...
	public function Create()
	{
		try
		{
			...
			// $pais->Idcountry = $this->SafeGetVal($json, 'idcountry');

			$pais->Country = $this->SafeGetVal($json, 'country');
			$pais->Countrycode = $this->SafeGetVal($json, 'countrycode');
	...
	public function Update()
	{
		try
		{
			...
			// $pais->Idcountry = $this->SafeGetVal($json, 'idcountry', $pais->Idcountry);

			$pais->Country = $this->SafeGetVal($json, 'country', $pais->Country);
			$pais->Countrycode = $this->SafeGetVal($json, 'countrycode', $pais->Countrycode);
