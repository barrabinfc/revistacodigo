...
/**
 * descricao_itemMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the descricao_itemDAO to the iteminscription datastore.
 *
 ...
 * @version 1.0
 */
class descricao_itemMap implements IDaoMap, IDaoMap2
{
