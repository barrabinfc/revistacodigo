...
/**
 * transcicaoMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the transcicaoDAO to the transcription datastore.
 *
 ...
 * @version 1.0
 */
class transcicaoMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		if (self::$FM == null)
		{
			...
			self::$FM["Institution"] = new FieldMap("Institution","transcription","institution",false,FM_TYPE_INT,11,null,false);
