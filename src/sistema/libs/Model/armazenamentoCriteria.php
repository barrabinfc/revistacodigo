...
require_once("DAO/armazenamentoCriteriaDAO.php");

/**
 * The armazenamentoCriteria class extends armazenamentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class armazenamentoCriteria extends armazenamentoCriteriaDAO
{
