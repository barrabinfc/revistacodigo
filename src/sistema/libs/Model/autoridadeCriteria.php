...
require_once("DAO/autoridadeCriteriaDAO.php");

/**
 * The autoridadeCriteria class extends autoridadeDAOCriteria and is used
 ...
 * @version 1.0
 */
class autoridadeCriteria extends autoridadeCriteriaDAO
{
