...
require_once("DAO/autoroleCriteriaDAO.php");

/**
 * The autoroleCriteria class extends autoroleDAOCriteria and is used
 ...
 * @version 1.0
 */
class autoroleCriteria extends autoroleCriteriaDAO
{
