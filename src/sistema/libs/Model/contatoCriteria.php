...
require_once("DAO/contatoCriteriaDAO.php");

/**
 * The contatoCriteria class extends contatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class contatoCriteria extends contatoCriteriaDAO
{
