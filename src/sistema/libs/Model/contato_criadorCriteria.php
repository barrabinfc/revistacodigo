...
require_once("DAO/contato_criadorCriteriaDAO.php");

/**
 * The contato_criadorCriteria class extends contato_criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class contato_criadorCriteria extends contato_criadorCriteriaDAO
{
