...
require_once("DAO/creator_award_honourCriteriaDAO.php");

/**
 * The creator_award_honourCriteria class extends creator_award_honourDAOCriteria and is used
 ...
 * @version 1.0
 */
class creator_award_honourCriteria extends creator_award_honourCriteriaDAO
{
