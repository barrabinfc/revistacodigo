...
require_once("DAO/criadorCriteriaDAO.php");

/**
 * The criadorCriteria class extends criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class criadorCriteria extends criadorCriteriaDAO
{
