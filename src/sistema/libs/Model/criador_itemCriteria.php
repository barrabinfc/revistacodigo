...
require_once("DAO/criador_itemCriteriaDAO.php");

/**
 * The criador_itemCriteria class extends criador_itemDAOCriteria and is used
 ...
 * @version 1.0
 */
class criador_itemCriteria extends criador_itemCriteriaDAO
{
