...
require_once("DAO/datalogCriteriaDAO.php");

/**
 * The datalogCriteria class extends datalogDAOCriteria and is used
 ...
 * @version 1.0
 */
class datalogCriteria extends datalogCriteriaDAO
{
