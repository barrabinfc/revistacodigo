...
require_once("DAO/descricao_fisicaCriteriaDAO.php");

/**
 * The descricao_fisicaCriteria class extends descricao_fisicaDAOCriteria and is used
 ...
 * @version 1.0
 */
class descricao_fisicaCriteria extends descricao_fisicaCriteriaDAO
{
