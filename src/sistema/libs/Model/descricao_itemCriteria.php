...
require_once("DAO/descricao_itemCriteriaDAO.php");

/**
 * The descricao_itemCriteria class extends descricao_itemDAOCriteria and is used
 ...
 * @version 1.0
 */
class descricao_itemCriteria extends descricao_itemCriteriaDAO
{
