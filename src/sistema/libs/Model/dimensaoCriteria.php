...
require_once("DAO/dimensaoCriteriaDAO.php");

/**
 * The dimensaoCriteria class extends dimensaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class dimensaoCriteria extends dimensaoCriteriaDAO
{
