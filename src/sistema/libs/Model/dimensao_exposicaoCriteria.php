...
require_once("DAO/dimensao_exposicaoCriteriaDAO.php");

/**
 * The dimensao_exposicaoCriteria class extends dimensao_exposicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class dimensao_exposicaoCriteria extends dimensao_exposicaoCriteriaDAO
{
