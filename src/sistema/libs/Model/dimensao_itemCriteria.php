...
require_once("DAO/dimensao_itemCriteriaDAO.php");

/**
 * The dimensao_itemCriteria class extends dimensao_itemDAOCriteria and is used
 ...
 * @version 1.0
 */
class dimensao_itemCriteria extends dimensao_itemCriteriaDAO
{
