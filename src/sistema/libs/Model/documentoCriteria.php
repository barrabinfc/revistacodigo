...
require_once("DAO/documentoCriteriaDAO.php");

/**
 * The documentoCriteria class extends documentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class documentoCriteria extends documentoCriteriaDAO
{
