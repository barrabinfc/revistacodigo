...
require_once("DAO/documento_midiaCriteriaDAO.php");

/**
 * The documento_midiaCriteria class extends documento_midiaDAOCriteria and is used
 ...
 * @version 1.0
 */
class documento_midiaCriteria extends documento_midiaCriteriaDAO
{
