...
require_once("DAO/expo_itemCriteriaDAO.php");

/**
 * The expo_itemCriteria class extends expo_itemDAOCriteria and is used
 ...
 * @version 1.0
 */
class expo_itemCriteria extends expo_itemCriteriaDAO
{
