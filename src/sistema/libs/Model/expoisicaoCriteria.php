...
require_once("DAO/expoisicaoCriteriaDAO.php");

/**
 * The expoisicaoCriteria class extends expoisicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class expoisicaoCriteria extends expoisicaoCriteriaDAO
{
