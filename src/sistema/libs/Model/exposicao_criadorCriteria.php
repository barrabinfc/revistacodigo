...
require_once("DAO/exposicao_criadorCriteriaDAO.php");

/**
 * The exposicao_criadorCriteria class extends exposicao_criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class exposicao_criadorCriteria extends exposicao_criadorCriteriaDAO
{
