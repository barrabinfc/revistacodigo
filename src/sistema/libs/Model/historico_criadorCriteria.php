...
require_once("DAO/historico_criadorCriteriaDAO.php");

/**
 * The historico_criadorCriteria class extends historico_criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class historico_criadorCriteria extends historico_criadorCriteriaDAO
{
