...
require_once("DAO/instituicaoCriteriaDAO.php");

/**
 * The instituicaoCriteria class extends instituicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class instituicaoCriteria extends instituicaoCriteriaDAO
{
