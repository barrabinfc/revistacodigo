...
require_once("DAO/item_midiaCriteriaDAO.php");

/**
 * The item_midiaCriteria class extends item_midiaDAOCriteria and is used
 ...
 * @version 1.0
 */
class item_midiaCriteria extends item_midiaCriteriaDAO
{
