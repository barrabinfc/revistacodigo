...
require_once("DAO/local_exposicaoCriteriaDAO.php");

/**
 * The local_exposicaoCriteria class extends local_exposicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class local_exposicaoCriteria extends local_exposicaoCriteriaDAO
{
