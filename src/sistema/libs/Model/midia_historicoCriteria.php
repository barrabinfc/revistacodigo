...
require_once("DAO/midia_historicoCriteriaDAO.php");

/**
 * The midia_historicoCriteria class extends midia_historicoDAOCriteria and is used
 ...
 * @version 1.0
 */
class midia_historicoCriteria extends midia_historicoCriteriaDAO
{
