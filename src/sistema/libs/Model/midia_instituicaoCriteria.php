...
require_once("DAO/midia_instituicaoCriteriaDAO.php");

/**
 * The midia_instituicaoCriteria class extends midia_instituicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class midia_instituicaoCriteria extends midia_instituicaoCriteriaDAO
{
