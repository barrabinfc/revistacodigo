...
require_once("DAO/midia_referenciaCriteriaDAO.php");

/**
 * The midia_referenciaCriteria class extends midia_referenciaDAOCriteria and is used
 ...
 * @version 1.0
 */
class midia_referenciaCriteria extends midia_referenciaCriteriaDAO
{
