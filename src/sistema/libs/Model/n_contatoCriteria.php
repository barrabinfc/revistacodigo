...
require_once("DAO/n_contatoCriteriaDAO.php");

/**
 * The n_contatoCriteria class extends n_contatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class n_contatoCriteria extends n_contatoCriteriaDAO
{
