...
require_once("DAO/n_historicoCriteriaDAO.php");

/**
 * The n_historicoCriteria class extends n_historicoDAOCriteria and is used
 ...
 * @version 1.0
 */
class n_historicoCriteria extends n_historicoCriteriaDAO
{
