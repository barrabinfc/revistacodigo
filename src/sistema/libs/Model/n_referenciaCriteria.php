...
require_once("DAO/n_referenciaCriteriaDAO.php");

/**
 * The n_referenciaCriteria class extends n_referenciaDAOCriteria and is used
 ...
 * @version 1.0
 */
class n_referenciaCriteria extends n_referenciaCriteriaDAO
{
