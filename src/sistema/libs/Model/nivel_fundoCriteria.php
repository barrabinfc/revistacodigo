...
require_once("DAO/nivel_fundoCriteriaDAO.php");

/**
 * The nivel_fundoCriteria class extends nivel_fundoDAOCriteria and is used
 ...
 * @version 1.0
 */
class nivel_fundoCriteria extends nivel_fundoCriteriaDAO
{
