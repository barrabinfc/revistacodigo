...
require_once("DAO/nivel_instituicoesCriteriaDAO.php");

/**
 * The nivel_instituicoesCriteria class extends nivel_instituicoesDAOCriteria and is used
 ...
 * @version 1.0
 */
class nivel_instituicoesCriteria extends nivel_instituicoesCriteriaDAO
{
