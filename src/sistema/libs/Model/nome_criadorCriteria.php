...
require_once("DAO/nome_criadorCriteriaDAO.php");

/**
 * The nome_criadorCriteria class extends nome_criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class nome_criadorCriteria extends nome_criadorCriteriaDAO
{
