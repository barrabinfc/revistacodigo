...
require_once("DAO/papel_usuarioCriteriaDAO.php");

/**
 * The papel_usuarioCriteria class extends papel_usuarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class papel_usuarioCriteria extends papel_usuarioCriteriaDAO
{
