...
require_once("DAO/possuidorCriteriaDAO.php");

/**
 * The possuidorCriteria class extends possuidorDAOCriteria and is used
 ...
 * @version 1.0
 */
class possuidorCriteria extends possuidorCriteriaDAO
{
