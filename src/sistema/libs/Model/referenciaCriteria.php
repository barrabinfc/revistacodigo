...
require_once("DAO/referenciaCriteriaDAO.php");

/**
 * The referenciaCriteria class extends referenciaDAOCriteria and is used
 ...
 * @version 1.0
 */
class referenciaCriteria extends referenciaCriteriaDAO
{
