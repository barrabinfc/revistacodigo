...
require_once("DAO/referencia_criadorCriteriaDAO.php");

/**
 * The referencia_criadorCriteria class extends referencia_criadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class referencia_criadorCriteria extends referencia_criadorCriteriaDAO
{
