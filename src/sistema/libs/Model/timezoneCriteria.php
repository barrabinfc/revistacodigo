...
require_once("DAO/timezoneCriteriaDAO.php");

/**
 * The timezoneCriteria class extends timezoneDAOCriteria and is used
 ...
 * @version 1.0
 */
class timezoneCriteria extends timezoneCriteriaDAO
{
