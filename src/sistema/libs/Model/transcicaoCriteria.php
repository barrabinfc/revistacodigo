...
require_once("DAO/transcicaoCriteriaDAO.php");

/**
 * The transcicaoCriteria class extends transcicaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class transcicaoCriteria extends transcicaoCriteriaDAO
{
