...
/**
 * This is an example Reporter based on the transcicao object.  The reporter object
 ...
 * @version 1.0
 */
class transcicaoReporter extends Reporter
{
	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`transcription`.`institution` as Institution
