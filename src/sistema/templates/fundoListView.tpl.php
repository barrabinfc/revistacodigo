<?php
	$this->assign('title','sistema | fundos');
	$this->assign('nav','fundos');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/fundos.js").wait(function(){
...
<h1>
	...
	<script type="text/template" id="fundoCollectionTemplate">
...
-->
	...
	<script type="text/template" id="fundoModelTemplate">
		...
		<form id="deletefundoButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deletefundoButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete fundo</button>
						<span id="confirmDeletefundoContainer" class="hide">
							<button id="cancelDeletefundoButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeletefundoButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="fundoDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit fundo
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="fundoModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="savefundoButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="fundoCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newfundoButton" class="btn btn-primary">Add fundo</button>
	</p>
